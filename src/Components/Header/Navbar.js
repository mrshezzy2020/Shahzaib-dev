...
import Binbox from "../Assets/Binbox.png";
import blck from "../Assets/blck.png";
import { useSelector } from "react-redux";
const Navbar = () => {
  const isLogin = useSelector((state) => state.is_loggedin);
        ...
        <>
          ...
          >
            <button
              ...
              type="button"
              className="btn fill focusRemove upload-btn "
              onClick={() => {
